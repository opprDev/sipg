...
if ( ! function_exists( 'business_club_setup' ) ) :
	 ...
	 */
	function business_club_setup() {

		// Make theme available for translation.
		load_theme_textdomain( 'business-club' );
		...
		add_image_size( 'business-club-thumb', 360, 270 );

		// Register nav menus.
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary Menu', 'business-club' ),
...
function business_club_scripts() {
	...
	wp_enqueue_style( 'business-club-style', get_stylesheet_uri(), array(), '1.1.0' );
	...
	wp_enqueue_script( 'business-club-custom', get_template_directory_uri() . '/js/custom' . $min . '.js', array( 'jquery' ), '1.0.1', true );
...
function business_club_admin_scripts( $hook ) {
	...
	if ( 'widgets.php' === $hook ) {
	    wp_enqueue_media();
		wp_enqueue_style( 'business-club-widgets', get_template_directory_uri() . '/css/widgets' . $min . '.css', array(), '1.0.0' );
		wp_enqueue_script( 'business-club-widgets', get_template_directory_uri() . '/js/widgets' . $min . '.js', array( 'jquery' ), '1.0.0', true );
	}
