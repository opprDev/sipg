...
if ( ! class_exists( 'Business_Club_Demo' ) ) {
	 ...
	 * @version 1.0.1
	 */
	class Business_Club_Demo {

		/**
		 * Singleton instance of Business_Club_Demo.
		 *
		 * @var Business_Club_Demo $instance Business_Club_Demo instance.
		 */
		...
		/**
		 * Main Business_Club_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Business_Club_Demo ) ) {
				self::$instance = new Business_Club_Demo();
